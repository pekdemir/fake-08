...
.PHONY: all 3ds switch wiiu vita sdl2 trimui sdl windows clean clean-3ds clean-switch clean-wiiu clean-vita clean-sdl2 clean-trimui clean-sdl clean-windows

all: 3ds switch wiiu vita bittboy windows trimui

clean: clean-tests clean-3ds clean-switch clean-wiiu clean-vita clean-sdl2 clean-sdl clean-bittboy clean-windows clean-trimui
